...
public class SearchFiles {
	...
	private static String field = "content";
...
//		Query query = new GeoPointInBBoxQuery("geo", 42.2279, 42.3969, -71.1908, -70.9235);
		Query query = new GeoPointInBBoxQuery("geo", minLat, maxLat, minLong, maxLong);
...
//		doPagingSearch(in, searcher, query, hitsPerPage, raw, queries == null && queryString == null);
	...
	public static void searchQuery(String queryIn, String index) throws ParseException, IOException  {
		// search in content
