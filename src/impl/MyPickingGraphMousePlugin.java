 ...
 * 
 * @author Tom Nelson
 * @editor Michael Hundt
 */
public class MyPickingGraphMousePlugin<V, E> extends AbstractGraphMousePlugin
	 ...
	 */
    public MyPickingGraphMousePlugin(int selectionModifiers, int addToSelectionModifiers) {
